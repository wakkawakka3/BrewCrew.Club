    ...
    <footer className="footer-container">
      <div className="footer-content">
        <div className="footer-logo-section">
          <Link to="/" className="footer-logo">BrewCrew Club</Link>
          <p className="footer-tagline">Discover, connect, and sip with a community of coffee lovers.</p>
        </div>
        <div className="footer-links-grid">
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              <li><Link to="/cafes"><span>Cafés</span></Link></li>
              <li><Link to="/forum"><span>Forum</span></Link></li>
              <li><Link to="/blog"><span>Guide</span></Link></li>
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links social-links">
              <li>
                <a href="mailto:hello@brewcrew.club">
      ...
      <div className="footer-bottom">
        <p>&copy; {new Date().getFullYear()} BrewCrew Club. All Rights Reserved.</p>
      ...
      <style jsx>{`
        ...
        .footer-links a span, .footer-legal-links a span {
          position: relative;
          padding-bottom: 4px;
        }
        .footer-links a span::after, .footer-legal-links a span::after {
          content: '';
          position: absolute;
          left: 0;
          bottom: 0;
        ...
        .footer-links a:hover span::after, .footer-legal-links a:hover span::after {
          width: 100%;
        }
        .social-links a svg {
