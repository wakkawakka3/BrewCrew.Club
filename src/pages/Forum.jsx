...
// Optimized Icons - Clean and Reusable
const SearchIcon = () => (
...
const HeartIcon = ({ liked }) => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill={liked ? '#e53e3e' : 'none'} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`heart-icon ${liked ? 'liked' : ''}`}>
                ...
                <header className="forum-hero">
                    ...
                    <div className="container hero-content">
                        ...
                        <h1 className="hero-title">
                            <span className="gradient-text">Connect</span> with Coffee Lovers
                        </h1>
                        <p className="hero-description">
                            Share your experiences, ask questions, and learn from fellow coffee enthusiasts in our vibrant community.
                        </p>
                ...
                <main className="container">
                    <div className="forum-layout">
                        ...
                        <aside className="forum-sidebar">
                            ...
                            <div className="sidebar-widget">
                                <h3>Quick Actions</h3>
                                <button className="new-post-btn-sidebar" onClick={() => setShowNewPostModal(true)}>
                                    <PlusIcon />
                        ...
                        <div className="forum-posts-section">
                            <div className="forum-toolbar">
                                <div className="search-box-forum">
                                    <SearchIcon />
                                    <input 
                                        type="text" 
                                        placeholder="Search discussions..." 
                                        className="search-input-forum" 
                                        value={searchQuery} 
                                            ...
                                            <div className="post-author-details">
                                                ...
                                                <div className="author-info">
                                                    ...
                                                    <span className="post-meta">
                                                        {post.handle} • {post.time} • {post.location}
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    <p className="post-content">{post.content}</p>
                                        <div className="post-footer">
                                            <div className="post-stats">
                                                ...
                                                >
                                                    <HeartIcon liked={likedPosts.includes(post.id)} />
                                                    <span>{post.likes + (likedPosts.includes(post.id) ? 1 : 0)}</span>
                                                </button>
                                                <button className="stat-btn" onClick={(e) => e.stopPropagation()}>
                                                    <MessageSquareIcon />
