  ...
  return (
    <Layout>
      ...
      <style jsx>{`
        ...
        .profile-header { background: var(--secondary-color); border-bottom: none; padding: 2rem 0 1.5rem 0; }
        .profile-info { display: flex; align-items: flex-start; justify-content: space-between; gap: 1.75rem; }
        ...
        .activity-tabs.pills .tab-button { border:1px solid var(--border-color); border-radius:999px; margin-right:.5rem; background:var(--secondary-color); box-shadow: 0 4px 10px rgba(0,0,0,.04); }
