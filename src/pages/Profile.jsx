...
const Profile = () => {
  ...
  const [user, setUser] = useState({
    ...
    followers: 1247,
    following: 892,
    profileImage: "https://placehold.co/150x150/d7a86e/3d2b1f?text=User"
  });
  ...
  const favoriteCafes = [
    { id: 1, name: "Blue Tokai Coffee", location: "Bandra, Mumbai", image: "https://placehold.co/300x200/a0572f/fff?text=Blue+Tokai" },
    { id: 2, name: "Third Wave Coffee", location: "Koramangala, Bangalore", image: "https://placehold.co/300x200/c07a4a/fff?text=Third+Wave" },
    { id: 3, name: "Koinonia Coffee Roasters", location: "Chuim Village, Mumbai", image: "https://placehold.co/300x200/7a3b17/fff?text=Koinonia" }
  ];
  ...
  return (
    <Layout noPadding>
      <div className="profile-page">
        ...
        <div className="container page-grid">
            <div className="profile-sidebar">
                ...
                <FavoriteCafes cafes={favoriteCafes} />
            </div>
      ...
      <style jsx>{`
        ...
        .profile-header { background: var(--secondary-color); border-bottom: none; padding: 1.5rem; border-radius: 14px; border: 1px solid var(--border-color); }
        .profile-info { display: flex; align-items: flex-start; justify-content: space-between; gap: 1.75rem; flex-direction: column; }
        .avatar-row { display:flex; justify-content:center; margin-top:-72px; margin-bottom:0.75rem; }
        .profile-avatar { width: 120px; height: 120px; border-radius:50%; padding:3px; background: linear-gradient(135deg, #f5c518, #fff); box-shadow:0 8px 24px rgba(0,0,0,.12); border: 3px solid #fff; }
        .profile-details { flex: 1; width: 100%; }
        ...
        .profile-stats { display:flex; gap:2rem; justify-content:center; padding: 1rem 0; border-top: 1px solid var(--border-color); margin-top: 1rem; }
        ...
        .profile-actions { display:flex; gap:.5rem; align-items:center; position:relative; justify-content: center; }
        .settings-button, .share-button { background:none; border:none; color:var(--text-muted); cursor:pointer; padding:.65rem; border-radius:50%; transition:all .2s ease; }
        ...
        .edit-profile-button { background: var(--primary-color); color: var(--text-light); border:none; padding:.65rem 1.25rem; border-radius:25px; font-weight:600; cursor:pointer; transition:all .2s ease; font-size:.9rem; box-shadow: 0 8px 16px rgba(0,0,0,.12); }
        .edit-profile-button:hover { background: var(--accent-color); transform: translateY(-1px); }
        
        .activity-section { padding-top: 1.5rem; }
        .activity-tabs { display:flex; border-bottom:1px solid var(--border-color); margin-bottom:1.25rem; }
        .tab-button { padding:.55rem 1.1rem; background:none; border:none; font-size:1rem; font-weight:600; color:var(--text-muted); cursor:pointer; border-bottom:2px solid transparent; transition:all .2s ease; display:flex; align-items:center; gap:.5rem; }
        .activity-tabs.pills { border-bottom: none; gap: .5rem; }
        .activity-tabs.pills .tab-button { border:1px solid var(--border-color); border-radius:999px; background:var(--secondary-color); box-shadow: 0 4px 10px rgba(0,0,0,.04); }
        .activity-tabs.pills .tab-button.active { background: rgba(245,197,24,.14); border-color: var(--accent-color); color: var(--primary-color); box-shadow: 0 8px 18px rgba(0,0,0,.06); }
        ...
        .activity-card { background:var(--secondary-color); border-radius:14px; padding:1.25rem; border:1px solid var(--border-color); transition:all .2s ease; box-shadow: 0 4px 12px rgba(0,0,0,.04); }
        .activity-card:hover { box-shadow:0 10px 24px rgba(0,0,0,.10); transform: translateY(-2px); }
        ...
        @media (max-width:768px){
          ...
          .page-grid { margin-top: -60px; }
          .avatar-row{ margin-top:-56px; }
